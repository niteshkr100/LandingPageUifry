...
const Faq = () => {
  return (
    <div className="container mx-auto mt-20 lg:px-32 ml-20px faq">
    <img src="/images/Star 9.png" alt="" className="star9"/>
                <p className="text-primary font-medium text-lg items-start">F A Q</p>
