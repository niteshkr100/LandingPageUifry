...
const Customize = () => {
  return (
    <div className="container mx-auto mb-20 ml-20px custstart">
      <div className="flex flex-col lg:flex-row justify-between items-center">
    
      <img src="/assets/customize.png" alt="" className="customize"/>
      <img src="/images/Star 6.png" alt="" className="star6"/>
